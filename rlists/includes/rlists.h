...
/*   Updated: 2016/03/30 06:40:39 by bkabbas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include <stdlib.h>
# include <rlists_typedefs.h>
# include <rlists_structs.h>
...
void	list_remove_range_inner(t_list *lst, int s, int e, void (*f)(t_node *));
/*
...
*/
void	list_process_range_inner(t_list *lst, int s, int e, void (*f)(void *));
/*
